    ...
    <div class="container">
        ...
        <form method="post" action="{{ route('entries.update', $entry->id) }}">
            ...
            <p class="control has-addons">
                <input class="input is-expanded" type="text" name="quantity" value="{{ old('quantity', $entry->quantity) }}">
                <span class="select">
            ...
            <p class="control">
                <span class="select">
                    <select class="select" name="product_id">
                        ...
                        <option value="{{ $product->id }}" @if($product->id == old('product_id', $entry->product_id)) selected="selected" @endif>{{ $product->name }}</option>
                        @endforeach
                    </select>
                </span>
            </p>
